...
.PHONY: test lab-validate evidence-local evidence-container evidence reproducibility skill-validate skill-eval provenance publication certificate core-validate core-audit cleanup-check check
...
check: test lab-validate skill-validate skill-eval evidence reproducibility cleanup-check provenance publication certificate core-validate core-audit
